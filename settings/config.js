...
module.exports = {
    ...
    DEV_ID: ["989430735561715712", "1064974505597993152"], // if you want to use command bot only, you can put your id here example: ["123456789", "123456789"]
    ...
    DEFAULT_SEARCH: "ytsearch" || "ytmsearch" || "spsearch" || "scsearch", // default search engine & "ytmsearch" / "ytsearch" / "scsearch" / "spsearch"
    NODES: [
      { 
        identifier: "OddCoder",

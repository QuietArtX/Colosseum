  ...
  run: async (interaction, client, user) => {
    ...
    collector.on('collect', async (b) => {
      ...
      if (b.user.id === interaction.user.id) return true;
              ...
              i.reply({ embeds: [new EmbedBuilder().setColor(client.color).setDescription(`Only **${uTag}** can use this button, if you want then you've run the command again!`)], ephemeral: true });
              return false;
      if (b.customId === "yes") {

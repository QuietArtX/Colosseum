...
module.exports = {
  ...
  options: [
    ...
    run: async (interaction, client, user) => {
      ...
      if(guild.members.me.roles.highest <= members.roles.highest.position) return interaction.editReply('can ban this member because your roles are same or higher')
